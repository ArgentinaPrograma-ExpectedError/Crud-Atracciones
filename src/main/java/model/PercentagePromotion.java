...
public class PercentagePromotion extends Promotion {
	...
	public PercentagePromotion(Integer id, String name, String attractionType, String promotionType, List<Attraction> attractions,
			String description, Boolean enable, Integer discount) {
